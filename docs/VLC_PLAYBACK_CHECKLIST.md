...
- Insert an Audio CD, open **Disc**, read the disc, and confirm Play Disc,
  Play Selected, Enqueue Selected, previous/next, seek, and eject behavior.
- Insert a DVD, open **Disc**, select DVD or Auto, and confirm playback opens
  in the Video player with menus when available.
- For DVDs that do not open with menus, retry **Play Without Menus** and confirm
  direct playback starts.
- Insert a VCD/SVCD if available, select VCD/SVCD, and confirm playback opens
  in the Video player.
...
- Repeat the Audio CD, DVD menu/no-menu, VCD/SVCD, and eject checks above.
