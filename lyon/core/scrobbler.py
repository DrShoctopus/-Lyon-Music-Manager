...
# Built binaries use _secrets.py (generated by CI from repo secrets, gitignored).
# Local dev: set LYON_LASTFM_API_KEY and LYON_LASTFM_API_SECRET env vars instead.
try:
    from ._secrets import LASTFM_API_KEY as _LASTFM_API_KEY, LASTFM_API_SECRET as _LASTFM_API_SECRET
except ImportError:
