...
# Packaged builds inject keys via lyon/core/_secrets.py (generated by CI from
# repository secrets).  For local / source runs, set LYON_LASTFM_API_KEY and
# LYON_LASTFM_API_SECRET environment variables instead.
try:
    from ._secrets import LASTFM_API_KEY as _LASTFM_API_KEY
    from ._secrets import LASTFM_API_SECRET as _LASTFM_API_SECRET
except ImportError:
    _LASTFM_API_KEY = (os.environ.get("LYON_LASTFM_API_KEY") or "").strip()
    _LASTFM_API_SECRET = (os.environ.get("LYON_LASTFM_API_SECRET") or "").strip()
