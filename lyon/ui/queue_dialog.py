...
class QueueDialog(QDialog):
    ...
    def _save_as_playlist(self) -> None:
        ...
        if not queue:
            return
        library_tracks = [track for track in queue if track.is_library_item]
        ...
        try:
            ...
            return
        self._library.add_to_playlist(pl_id, [t.id for t in library_tracks])
